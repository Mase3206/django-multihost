> [!CAUTION]
> This documentation was taken from v1 and is basically unedited. ***DO NOT FOLLOW THESE INSTRUCTIONS FOR DEPLOYMENT!***
...
FORCE_SCRIPT_NAME = (
	'/' + env.str('SITE_PATH', default=None)  # if the SITE_PATH env variable is set
	if not env.str('SITE_PATH', default=None) # if not
